...
class ChartGenerator:
    ...
    def plot_metrics(self, metrics: Dict[str, List[float]], title: str = "Training Metrics"):
        ...
        _fig, axes = plt.subplots(1, 1, figsize=(8, 5))
    ...
    def plot_feature_importance(self, importance: Dict[str, float], top_n: int = 20):
        ...
        features, scores = zip(*sorted_items, strict=False)
    ...
    def plot_learning_curve(
        self, train_sizes: List[float], train_scores: List[float], val_scores: List[float]
    ):
        """Plot learning curve."""
        _fig, ax = plt.subplots(figsize=(8, 5))
